...
### Why Passport.js Authentication
...
4. Enable uma_rpt_policy and uma_client_authz_rpt_policy in UMA RPT Policies tab.![uma-policies](/img/passport/uma-policies.png)
5. Click on update.
